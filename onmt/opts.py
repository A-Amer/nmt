...
def model_opts(parser):
    ...
    group.add('--single_enc_double_dec_layers', '-single_enc_double_dec_layers', action='store_true')
    ...
    group.add('--encoder_type', '-encoder_type', type=str, default='rnn',
              choices=['rnn', 'brnn', 'res', 'transformer'],
              help="Type of encoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|brnn|res|transformer].")
    group.add('--decoder_type', '-decoder_type', type=str, default='rnn',
              choices=['rnn', 'transformer'],
              help="Type of decoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|transformer].")
    group.add('--gnmt', '-gnmt', action='store_true')
    ...
    group.add('--global_attention_function', '-global_attention_function',
              type=str, default="softmax", choices=["softmax"])
